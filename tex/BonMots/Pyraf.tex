\renewcommand{\footerfilename}{Pyraf.tex}

\section{Pyraf}

Currently the reduction package is running in a docker file.

\begin{tcolorbox}[title=Pyraf alias entry for bash]
\begin{verbatim}
function pyraf { export LOCALDATA=$(pwd);
                 export SPECDATA=$HOME/Observations/reduce;
...
%
\subsection{Basic Structural Details}

After the basic PyRAF start, 
iraf. ... has 708 things instantiated.
...
show home
   ...
   QtCairo, TkAgg,     TkCairo, WebAgg,    WX,     WXAgg, WXCairo,  Qt5Agg,
   Qt5Cairo
