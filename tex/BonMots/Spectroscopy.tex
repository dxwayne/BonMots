...
\begin{verbatim} 
    ...
    hedit     flat.0001.fits  REFSPEC1  comp.0001.fits add+ update+ ver- show-
    dispcor   sci.0001.fits   cal_sci.0001.fits                    # WCS to file.
    dispcor   flat.0001.fits  cal_sci.0001.fits                    # WCS to file.
\end{verbatim}
}
\endgroup
%% \end{Verbatim}
