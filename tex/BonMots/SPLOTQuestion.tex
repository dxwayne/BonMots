\renewcommand{\footerfilename}{SPLOTQuestion.tex}

\subsection{Splot Help}
%\ltodo{Splot Help}{Need to add more tricks.}
Handy Splot Tricks:
...
a - a   set the autoexpand ('aperture') sides. (Zoom in)
              aa (no cursor move -- zoom out)

e - e   take Equiv. width, integ flux, center across the area.
...
y print star flux from calib file

Dangerous Keys:
p asks for low, high and converts to that scale.
