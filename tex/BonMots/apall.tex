\renewcommand{\footerfilename}{apall.tex}
...
The \gls{g-apall} task requires a few things:
\vspace{-.15cm}
...
%\setcounter{enumi}{N}
   ...
   \item   \gls{g-background} b\_sample = "-20:-15,15,20" sets the little background
...
\dhl{Trace \gls{apertures} for Vega\_Light\_006?} is the next question. yes \\
