...
\renewcommand{\footerfilename}{IdentifyLPARS.tex}

\section{Identify}

Some important aspects for small telescope science relates to the
camera's pixel size. Measure and change here as needed.
