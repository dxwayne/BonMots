\renewcommand{\footerfilename}{SpectroStandards.tex}

\section{Create a IRAF Standard Star}

The calibration files contained in noao/lib/onedstds consist of lines
with wavelengths in Angstroms, calibration magnitudes, and bandpass
widths in Angstroms. The magnitudes are converted to absolute flux per
unit frequency using the parameter fnuzero defined by:
...
is the table reported magnitude. See \cite{1983ApJ...266..713O} for a
discussion of the AB magnitude system .
...
versions of this task.\footnote{These values vary by a small amount.}
