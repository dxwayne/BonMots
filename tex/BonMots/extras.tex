...
\renewcommand{\footerfilename}{extras.tex}
...
is a one-liner for PyRAF that finds all cosmic-ray files (by our
convention), uses {\color{verbcolor}{\verb#tee#}} to save a copy in a
file called in.txt, then uses sed to prepend the
{\color{verbcolor}{\verb#c_#}} to each line which saves the modified
name into a file called {\color{verbcolor}{\verb#out.list#}}.  No
