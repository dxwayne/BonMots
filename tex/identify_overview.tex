...
\section{Identification of Calibration Arc Lines with fast instruments.}

The astigmatisms in commercial small, fast amateur spectrographs
requires some careful attention to detail for achiving a decent
wavelegnth calibration and response curve. The discussion of
the problem in \cite{Massey1} with the ``smile''.
...
% /home/wayne/iraf/smtsci/doc/identify_overview.tex
